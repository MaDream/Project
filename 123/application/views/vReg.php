        ...
        <div class="container auth">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <form class="form-horizontal" role="form" method = "post" action = "http://188.134.19.176:8001/index.php/reg/reg_user">
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                          <button type="submit" class="btn btn-success">Зарегистрироваться</button>
                              <a href="http://188.134.19.176:8001/index.php/auth" class="btn btn-info right">Авторизация</a>
